...
const TABS = ["settings", "questions", "proof", "leads", "availability"];
    ...
    <div className="max-w-4xl mx-auto mt-10 card p-6 space-y-6">
      ...
      {activeTab !== "settings" && (
        <div className="py-10 text-center text-sm text-white/60">
          <p className="mb-1 capitalize">{activeTab}</p>
          <p className="text-xs text-white/40">
            This section will mirror the Logan panel for {activeTab}. We&apos;ll
            wire it up once the data model is in place.
          </p>
        </div>
      )}
    </div>
